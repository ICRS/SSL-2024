...
int main(void)
{
  ...
  HAL_GPIO_WritePin(M1_EN_GPIO_Port, M1_EN_Pin, SET);
  HAL_GPIO_WritePin(M2_EN_GPIO_Port, M2_EN_Pin, SET);
  HAL_GPIO_WritePin(M3_EN_GPIO_Port, M3_EN_Pin, SET);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, M1_IN2_Pin|M1_IN1_Pin|M1_EN_Pin|M3_IN1_Pin
                          |M2_IN1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(M2_EN_GPIO_Port, M2_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|M3_IN2_Pin|M3_EN_Pin|LD3_Pin
  ...
  /*Configure GPIO pins : M1_IN2_Pin M1_IN1_Pin M1_EN_Pin M3_IN1_Pin
                           M2_IN1_Pin */
  GPIO_InitStruct.Pin = M1_IN2_Pin|M1_IN1_Pin|M1_EN_Pin|M3_IN1_Pin
                          |M2_IN1_Pin;
  ...
  /*Configure GPIO pins : LD1_Pin M3_IN2_Pin M3_EN_Pin LD3_Pin
                           LD2_Pin */
  GPIO_InitStruct.Pin = LD1_Pin|M3_IN2_Pin|M3_EN_Pin|LD3_Pin
                          |LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
