...
uint32_t sensorsTaskBuffer[ 512 ];
...
extern void startRadioTask(void *argument);
extern void startMotorTask(void *argument);
extern void startSensorsTask(void *argument);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, TRIG2_Pin|TRIG1_Pin|CAN2_SILENT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CAN1_SILENT_GPIO_Port, CAN1_SILENT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, NRF24_CSN_Pin|LED_B_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, NRF24_CE_Pin|NRF24_MODE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MAG_INT_Pin BTN2_Pin IMU_INT1_Pin */
  GPIO_InitStruct.Pin = MAG_INT_Pin|BTN2_Pin|IMU_INT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : CAN2_SILENT_Pin */
  GPIO_InitStruct.Pin = CAN2_SILENT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CAN2_SILENT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : CAN1_SILENT_Pin */
  GPIO_InitStruct.Pin = CAN1_SILENT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CAN1_SILENT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : NRF24_CSN_Pin LED_B_Pin */
  GPIO_InitStruct.Pin = NRF24_CSN_Pin|LED_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : NRF24_CE_Pin NRF24_MODE_Pin */
  GPIO_InitStruct.Pin = NRF24_CE_Pin|NRF24_MODE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : NRF24_IRQ_Pin IMU_INT2_Pin */
  GPIO_InitStruct.Pin = NRF24_IRQ_Pin|IMU_INT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
